...
var form = document.getElementById("forms"); //GET REQUEST

axios.get("https://api.vschool.io/Mark_Olivo/todo").then(function (response) {
  var _loop = function _loop(i) {
    ...
    li.appendChild(h4); //CHECKBOX - LINE-THROUGH
    ...
    button.addEventListener("click", function (event) {
      axios.delete("https://api.vschool.io/Mark_Olivo/todo/" + event.currentTarget.id).then(function (response) {
        response.data;
        location.reload();
      }).catch(function (error) {
        return console.log(error);
    ...
    submits.addEventListener("click", function (event) {
      ...
      var d = document.getElementById("detailsInput").value;
      var p = document.getElementById("numberInput").value;
...
form.addEventListener("submit", function (event) {
  ...
  axios.post("https://api.vschool.io/Mark_Olivo/todo", newTodo).then(function (response) {
    response.data;
    form.reset();
    location.reload();
  }).catch(function (error) {
