...
exports.removeTodoElement = exports.deleteTodoItem = exports.addTodoItem = void 0;
...
// GET....
var BASE_URL = "https://api.vschool.io/mark.olivo/todo";
...
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(event) {
    var title, description, price, todo, submitTodoItem;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _axios.default.post("".concat(BASE_URL), todo);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            console.log("id", id);
            _context6.next = 4;
            return _axios.default.delete("".concat(BASE_URL, "/").concat(id));
...
exports.removeTodoElement = removeTodoElement;
